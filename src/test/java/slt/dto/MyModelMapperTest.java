...
//        assertThat(mapped.getIngredients().get(0).getFood().getId()).isEqualTo(dto.getIngredients().get(0).getFood().getId());
//        assertThat(mapped.getIngredients().get(0).getMultiplier()).isEqualTo(dto.getIngredients().get(0).getMultiplier());
//        assertThat(mapped.getIngredients().get(0).getPortion().getId()).isEqualTo(dto.getIngredients().get(0).getPortion().getId());
//    }
//
//    @Test
...
//        assertThat(ingredientMapped.getPortion().getId()).isEqualTo(2L);
//        assertThat(ingredientMapped.getFood().getId()).isEqualTo(30L);
...
//        assertThat(ingredientMappedBack.getPortion().getId()).isEqualTo(2L);
//        assertThat(ingredientMappedBack.getFood().getId()).isEqualTo(30L);
